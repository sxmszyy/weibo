...
public class ShipingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        _imgWeibo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ShipingActivity.this, WeiBoActivity.class);
        ...
        _imgFaxian.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ShipingActivity.this, FaxianActivity.class);
                intent.putExtra("phone", Phone);
                startActivity(intent);
            }
        });
        ...
        _imgXiaoxi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ShipingActivity.this, XiaoxiActivity.class);
                intent.putExtra("phone", Phone);
                startActivity(intent);
            }
        });
        ...
        _imgWo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ShipingActivity.this, WoActivity.class);
                intent.putExtra("phone", Phone);
                startActivity(intent);
            }
        });
    ...
    private void initData(){
        ...
        ///添加数据
        _data.add( new weiboshow_1(R.drawable.shiping_1));
        _data.add( new weiboshow_1(R.drawable.shiping_2));
        _data.add( new weiboshow_1(R.drawable.shiping_3));
        _data.add( new weiboshow_1(R.drawable.shiping_4));
        _data.add( new weiboshow_1(R.drawable.shiping_5));
        _data.add( new weiboshow_1(R.drawable.shiping_6));
        _data.add( new weiboshow_1(R.drawable.shiping_7));
    }
}
