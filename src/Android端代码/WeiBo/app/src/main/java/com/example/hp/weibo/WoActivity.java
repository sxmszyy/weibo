    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        _imgWeibo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(WoActivity.this, WeiBoActivity.class);
        ...
        _imgShiping.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(WoActivity.this, ShipingActivity.class);
                intent.putExtra("phone", Phone);
                startActivity(intent);
            }
        });
        ...
        _imgFaxian.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(WoActivity.this, FaxianActivity.class);
                intent.putExtra("phone", Phone);
                startActivity(intent);
            }
        });
        ...
        _imgXiaoxi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(WoActivity.this, XiaoxiActivity.class);
                intent.putExtra("phone", Phone);
                startActivity(intent);
            }
        });
